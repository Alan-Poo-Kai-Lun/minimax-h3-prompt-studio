(() => {
  ...
  function applyDynamic() {
    ...
    if (changelog) {
      ...
      const currentValue = language() === "en" ? '<b>v0.8.16</b><ul><li>Checks raw H3 output for duplicate or empty fields before normalization and repair</li><li>Updates source build instructions and both READMEs</li></ul>' + value : value;
